Got it! Here is the revised version with the references placed at the bottom of the document in a suffix reference list format with associated links that include your associate ID.
